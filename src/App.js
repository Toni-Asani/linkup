...
<h1 style={{fontSize:32,fontWeight:700,letterSpacing:'-1px',animation:'fadeUp 0.6s ease 0.2s both',fontFamily:'Fredoka One, sans-serif', fontWeight:400, letterSpacing:'0px'}}>hubbing</h1>
      {/* Badge lancement */}
...
/>
    ...
    <>
      ...
      {activeTab === 'messages' && <MessagesScreen user={user} plan={userPlan} setSelectedCompanyId={setSelectedCompanyId} setActiveTab={setActiveTab} />}
