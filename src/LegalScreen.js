  ...
  fr: {
    ...
    cgu: {
      ...
      sections: [
        ...
        { title: '7. Propriété intellectuelle', content: "L'ensemble du contenu de Hubbing (logo, design, code, textes) est la propriété exclusive de Hubbing. Toute reproduction non autorisée est interdite et passible de poursuites." },
        { title: '8. Droit applicable et juridiction', content: "Les présentes CGU sont soumises au droit suisse. Tout litige sera soumis aux tribunaux compétents du canton de Vaud, Suisse, à l'exclusion de tout autre tribunal." },
      ]
    },
    confidentialite: {
  ...
  de: {
    ...
    cgu: {
      ...
      sections: [
        ...
        { title: '7. Anwendbares Recht', content: "Diese AGB unterliegen dem Schweizer Recht. Alle Streitigkeiten werden den zuständigen Gerichten des Kantons Waadt, Schweiz, vorgelegt." },
      ]
    },
    confidentialite: {
  ...
  it: {
    ...
    cgu: {
      ...
      sections: [
        ...
        { title: '7. Diritto applicabile', content: "Le presenti CGU sono soggette al diritto svizzero. Qualsiasi controversia sarà sottoposta ai tribunali competenti del Canton Vaud, Svizzera." },
      ]
    },
    confidentialite: {
  ...
  en: {
    ...
    cgu: {
      ...
      sections: [
        ...
        { title: '7. Applicable law', content: "These T&C are governed by Swiss law. Any dispute will be submitted to the competent courts of the Canton of Vaud, Switzerland." },
      ]
    },
    confidentialite: {
