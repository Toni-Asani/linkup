...
const legalContent = {
  fr: {
    ...
    confidentialite: {
      ...
      sections: [
        { title: '1. Données collectées', content: "Hubbing collecte les données suivantes :\n• Informations d'entreprise (nom, numéro IDE, adresse, secteur)\n• Informations du décideur (nom, prénom, titre, photo, LinkedIn)\n• Adresse email professionnelle\n• Données d'utilisation (matchs, messages, connexions, avis)\n• Données de localisation (canton, coordonnées GPS si activées)\n• Métadonnées et fichiers que vous ajoutez volontairement aux besoins (nom du fichier, type, taille, date d'ajout, pièce jointe)\n• Informations liées aux signalements de contenus ou de pièces jointes" },
        { title: '2. Utilisation des données', content: "Vos données sont utilisées exclusivement pour :\n• Le fonctionnement de la plateforme\n• La mise en relation avec d'autres entreprises\n• L'envoi de notifications liées à votre activité\n• L'amélioration de nos services\n• La vérification de conformité\n• Le stockage sécurisé des pièces jointes liées aux besoins\n• La modération, le traitement des abus et la gestion des signalements" },
        { title: '3. Partage des données', content: "Hubbing ne vend jamais vos données à des tiers. Les informations de votre profil sont visibles par les autres entreprises inscrites dans le cadre normal d'utilisation de la plateforme.\n\nLe Cloud Hubbing privé est accessible uniquement au propriétaire du compte concerné. Les autres entreprises ne peuvent pas consulter le cloud privé d'un autre abonné.\n\nLes pièces jointes associées à un besoin peuvent être visibles par les entreprises inscrites qui consultent le profil, selon le plan et les droits d'accès. Les signalements peuvent transmettre à Hubbing les informations nécessaires à l'examen du fichier signalé." },
        ...
        { title: '5. Vos droits', content: "Conformément au nLPD, vous disposez du droit d'accès, de rectification et de suppression de vos données. Pour exercer ces droits : contact@hubbing.ch" },
    ...
    responsabilite: {
      ...
      sections: [
        ...
        { title: '4. Contenu des messages', content: "Hubbing n'est pas responsable du contenu des messages échangés entre utilisateurs. Tout abus peut être signalé à contact@hubbing.ch" },
        ...
        { title: '7. Pièces jointes, cloud privé et téléchargements', content: "Le Cloud Hubbing est accessible uniquement au propriétaire du compte concerné. Les pièces jointes associées aux besoins peuvent être visibles par les entreprises inscrites lorsqu'elles consultent le profil, selon les droits du plan utilisé.\n\nLes utilisateurs restent seuls responsables des fichiers qu'ils ajoutent, consultent, téléchargent ou partagent. Hubbing ne peut garantir l'exactitude, la légalité ou la qualité des documents fournis par les entreprises. Hubbing peut bloquer, supprimer ou signaler tout fichier contraire aux CGU ou à la loi suisse." },
      ]
    },
    mentions: {
      ...
      sections: [
        ...
        { title: 'Contact', content: "Questions légales : contact@hubbing.ch\nProtection des données : contact@hubbing.ch\nAbus et signalements : contact@hubbing.ch\nSupport : contact@hubbing.ch" },
      ]
    }
  },
  de: {
    ...
    confidentialite: {
      ...
      sections: [
        ...
        { title: '4. Ihre Rechte', content: "Gemäss revDSG haben Sie das Recht auf Auskunft, Berichtigung und Löschung Ihrer Daten. Kontakt: contact@hubbing.ch" },
    ...
    responsabilite: {
      ...
      sections: [
        ...
        { title: '4. Nachrichteninhalte', content: "Hubbing ist nicht verantwortlich für den Inhalt der zwischen Nutzern ausgetauschten Nachrichten. Missbrauch kann an contact@hubbing.ch gemeldet werden." },
      ]
    },
    mentions: {
      title: 'Impressum',
      ...
      sections: [
        ...
        { title: 'Kontakt', content: "Rechtliche Fragen: contact@hubbing.ch\nDatenschutz: contact@hubbing.ch\nMissbrauch: contact@hubbing.ch\nSupport: contact@hubbing.ch" },
      ]
    }
  },
  it: {
    ...
    confidentialite: {
      ...
      sections: [
        ...
        { title: '4. I vostri diritti', content: "In conformità con la nLPD, avete il diritto di accesso, rettifica e cancellazione dei vostri dati. Contatto: contact@hubbing.ch" },
    ...
    responsabilite: {
      ...
      sections: [
        ...
        { title: '4. Contenuto dei messaggi', content: "Hubbing non è responsabile del contenuto dei messaggi scambiati tra utenti. Gli abusi possono essere segnalati a contact@hubbing.ch" },
      ]
    },
    mentions: {
      title: 'Note Legali',
      ...
      sections: [
        ...
        { title: 'Contatto', content: "Questioni legali: contact@hubbing.ch\nPrivacy: contact@hubbing.ch\nAbusi: contact@hubbing.ch\nSupporto: contact@hubbing.ch" },
      ]
    }
  },
  en: {
    ...
    confidentialite: {
      ...
      sections: [
        ...
        { title: '4. Your rights', content: "In accordance with the revFADP, you have the right of access, rectification and deletion of your data. Contact: contact@hubbing.ch" },
    ...
    responsabilite: {
      ...
      sections: [
        ...
        { title: '4. Message content', content: "Hubbing is not responsible for the content of messages exchanged between users. Abuse can be reported to contact@hubbing.ch" },
      ]
    },
    mentions: {
      title: 'Legal Notice',
      ...
      sections: [
        ...
        { title: 'Contact', content: "Legal questions: contact@hubbing.ch\nData protection: contact@hubbing.ch\nAbuse: contact@hubbing.ch\nSupport: contact@hubbing.ch" },
      ]
    }
  }
}
